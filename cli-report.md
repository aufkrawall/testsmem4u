...
- Presets that fail to load, reference unknown tests/functions, or resolve to zero runnable tests.
...
- Large-page allocation results as full, partial/hybrid, or disabled at runtime.
- Thread count.
- Cycle count.
...
| 2 | CLI, config, preset, validation, or runtime infrastructure failure. |
